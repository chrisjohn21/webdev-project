                        ...
                        <?php
                            ...
                            if (!empty($productList)) {
                                foreach ($productList as $product) {
                                    ...
                                    echo '<td id="quantity-' . $product->getId() . '" data-quantity="' . $product->getQuantity() . '">' . $product->getQuantity() . '</td>';
                                    echo '<td>
                                            ...
                                            <button class="btn btn-sm btn-info" onclick="editProduct(' . $product->getId() . ')">Edit</button>
                                          </td>';
                                    echo '</tr>';

                                    // Check if the quantity is 0, and display SweetAlert
                                    if ($product->getQuantity() == 0) {
                                        echo '<script>
                                                Swal.fire({
                                                    icon: \'warning\',
                                                    title: \'Product Sold Out\',
                                                    text: \'The product ' . $product->getName() . ' is sold out.\',
